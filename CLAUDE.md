...
- DB: sql.js(SQLite WASM), 메모리 인스턴스 `db`. 테이블: works/chapters/characters/lore/plots/timeline/notes/writing_log/cats/meta (cats=공통 카테고리 kind=lore|plot|char|event(연표 유형,색); timeline=연표; lore_cats는 레거시).
