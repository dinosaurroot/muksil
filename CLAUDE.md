...
- DB: sql.js(SQLite WASM), 메모리 인스턴스 `db`. 테이블: works/chapters/characters/lore/plots/notes/writing_log/cats/meta (cats=공통 카테고리 kind=lore|plot|char; lore_cats는 레거시).
